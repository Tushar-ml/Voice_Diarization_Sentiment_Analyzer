...
if __name__ == '__main__':
    ...
    print(speaker_diarization(filename=r'C:\Users\TusharGoel\Desktop\Flask-SocketIO-Audio\example\uploads\test_dsw_formatted.wav',n_speakers=2,lda_dim=0,plot_res=True))
