...
let DEEPSPEECH_MODEL =  'deepspeech-model'; // path to deepspeech english model directory
...
var recordbutton = document.getElementId('recording').addEventListener('click',startMicrophone)
var recordbutton = document.getElementId('stop').addEventListener('click',stopMicrophone)
